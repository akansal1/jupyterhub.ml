...
c.Spawner.env_keep = ['PATH', 'PYTHONPATH', 'CONDA_ROOT', 'CONDA_DEFAULT_ENV', 'VIRTUAL_ENV', 'LANG', 'LC_ALL', 'SPARK_HOME', 'PYSPARK_PYTHON', 'SPARK_MASTER', 'SPARK_MASTER_HOST', 'SPARK_MASTER_PORT', 'PYSPARK_SUBMIT_ARGS', 'JUPYTER_PROFILE', 'SPARK_SUBMIT_PACKAGES', 'SPARK_SUBMIT_JARS', 'SPARK_SUBMIT_PYFILES']
